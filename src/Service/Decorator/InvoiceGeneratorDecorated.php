 ...
 * @package   Welo\PlatformInvoiceEmail\Service\Decorator
 * @version   1
 */
class InvoiceGeneratorDecorated implements DocumentGeneratorInterface
{
    ...
    public function generate(
        ...
        $config->assign(['invoiceEmail' => $invoiceEmail]);
