...
namespace Welo\PlatformInvoiceEmail\Service;
 ...
 * @package   Welo\PlatformInvoiceEmail\Service
 * @version   1
 */
class Configuration
{
    ...
    public const WELO_CONFIG_DOMAIN = 'WeloPlatformInvoiceEmail.config.';
    ...
    {
        //die('here '.self::WELO_CONFIG_DOMAIN . $key);
